...
import CustomMasonryImages from '../components/customMasonryImages';

function MasonryImagesScreen() {
  const data = [
    {
      id: 'id123',
      imgURL:
...
export default MasonryImagesScreen;
